...
INSERT INTO customer (customerID,firstname,lastname,email,password) VALUES (1,"Garrison","Jordan","sit.amet.ornare@nequesedsem.edu","password1"),
...
CREATE TABLE IF NOT EXISTS booking (
  ...
  CONSTRAINT booking_room_fk FOREIGN KEY (roomID) REFERENCES room (roomID),
  CONSTRAINT booking_customer_fk FOREIGN KEY (customerID) REFERENCES customer (customerID)
) AUTO_INCREMENT=1;
